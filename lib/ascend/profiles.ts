...
export const ascendProfiles: Record<AscendProfileSlug, AscendProfile> = {
  ...
  "night-nectar": { slug: "night-nectar", nameEn: "NIGHT NECTAR", nameZh: "星津", title: "CREATIVE ENERGY", keywords: ["Imaginative", "Expressive", "Curious", "Lively"], message: ["Your energy grows when ideas are allowed to move freely.", "Today is a day to explore, create and follow the spark that others may overlook.", "Stay curious.", "Let inspiration rise."], quote: "Stay curious. Let inspiration rise.", image: "/assets/menu/02-night-nectar.PNG", theme: { background: "#11182d", accent: "#e5b96c", glow: "#a47bb4" } },
  evenfall: { slug: "evenfall", nameEn: "EVENFALL", nameZh: "归岚", title: "GENTLE COMPANION", keywords: ["Warm", "Comforting", "Thoughtful", "Kind"], message: ["You bring calm to the people and places around you.", "Today is a day for warmth, familiar moments and meaningful company.", "Stay gentle.", "Keep moving upward."], quote: "Stay gentle. Keep moving upward.", image: "/assets/menu/03-evenfall.PNG", theme: { background: "#37251f", accent: "#e3b87e", glow: "#c98579" } },
  clearsky: { slug: "clearsky", nameEn: "CLEARSKY", nameZh: "破云", title: "FRESH PERSPECTIVE", keywords: ["Clear-minded", "Refreshing", "Optimistic", "Direct"], message: ["Sometimes the next step appears only after the clouds begin to part.", "Today is a day to clear the noise and see things differently.", "Breathe deeply.", "Begin again."], quote: "Breathe deeply. Begin again.", image: "/assets/menu/04-clear-sky.PNG", theme: { background: "#173847", accent: "#e5ba67", glow: "#5a8492" } },
  monsoon: { slug: "monsoon", nameEn: "MONSOON", nameZh: "长风", title: "BOLD EXPLORER", keywords: ["Adventurous", "Confident", "Restless", "Open-minded"], message: ["You are drawn toward movement, discovery and what lies beyond the familiar.", "Today is a day to choose the road you have not taken before.", "Move boldly.", "Ascend freely."], quote: "Move boldly. Ascend freely.", image: "/assets/menu/06-monsoon.PNG", theme: { background: "#10372d", accent: "#efbd65", glow: "#5d8c78" } },
  drift: { slug: "drift", nameEn: "DRIFT", nameZh: "云隐", title: "FREE SPIRIT", keywords: ["Independent", "Relaxed", "Intuitive", "Unhurried"], message: ["Not every meaningful journey follows a straight line.", "Today is a day to trust your pace and leave room for surprise.", "Flow naturally.", "Rise in your own way."], quote: "Flow naturally. Rise in your own way.", image: "/assets/menu/09-drift.PNG", theme: { background: "#3f2f32", accent: "#e4aa98", glow: "#956f72" } },
