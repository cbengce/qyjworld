export type AscendEventName = "ascend_start_quiz" | "ascend_question_completed" | "ascend_complete_quiz" | "ascend_result_viewed" | "ascend_card_generated" | "ascend_download_card" | "ascend_share_card" | "ascend_link_copied" | "ascend_try_again" | "ascend_menu_clicked" | "ascend_referral_visit" | "ascend_referral_completion" | "ascend_reward_unlock";
